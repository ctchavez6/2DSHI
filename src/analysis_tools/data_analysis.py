...
def get_analysis_parameters(csv_files_parent_directory):
    ...
    if does_setup_file_exist(csv_files_parent_directory) is True:
        ...
        if user_choice == 4:
            print("you picked radial star")
            r_star_options["num_lines"] = int(input("number of lines: "))
            r_star_options["x_offset"] = int(input("x offset: "))
            r_star_options["y_offset"] = int(input("y offset: "))
            ...
            params_as_a_string += "num_lines"
            params_as_a_string += "\t"
            params_as_a_string += str(r_star_options["num_lines"])
            params_as_a_string += "\n"

            # x offset
            params_as_a_string += "x_offset"
            params_as_a_string += "\t"
            params_as_a_string += str(r_star_options["x_offset"])
            params_as_a_string += "\n"
            # y offset
            params_as_a_string += "y_offset"
            params_as_a_string += "\t"
            params_as_a_string += str(r_star_options["y_offset"])
            params_as_a_string += "\n"
