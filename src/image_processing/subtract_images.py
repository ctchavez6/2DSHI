...
img_b_prime = cv2.imread(img_b_path, cv2.IMREAD_ANYDEPTH)





a_minus_b_prime = cv2.subtract(img_a, img_b_prime)
...
cv2.waitKey(5000)
cv2.imshow("A Minus B Prime", a_minus_b_prime)
cv2.waitKey(5000)



save_img("A_Minus_B_Prime.png", algebra_directory, a_minus_b_prime)
