...
if __name__ == "__main__":
    ...
    delineator = str(input("Enter Delineator: Calibration, Data, Other: "))
    if delineator == "" or None:
        delineated = current_datetime
    else:
        delineated = current_datetime + "_" + delineator
    run_directory = os.path.join("D:", "\\" + delineated)
    ...
    wptf.document_run(args, delineated)

    print("\nAll Experimental Data will be saved in the following directory:\n\tD:\\{}".format(current_datetime) + "_" + delineator)
    print("\nStarting Run: {}\n".format(current_datetime)+ delineator)
    ...
    stream.delineator = "_" + delineator
