...
# CQT_Run_Custom_Test.sh
# Template shell script to run custom testing routines.

# Change working directory from /Users/<username> to current directory.
# This way, the zip file of results is created here for convinience.
cd "$(dirname "$0")"

# Run the program as sudo for best performance (increased grab thread priority, etc.)
# sudo ./CameraQuickTester

# Run the program as current user
./CameraQuickTester

# Available CQT commandline arguments (e.g.: ./CameraQuickTester -wipecamera)
#
# GENERAL OPTIONS:
